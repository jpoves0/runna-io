...
function StartActivityButton() {
  ...
  const bottomOffset = isStandalone ? 'calc(5rem + 20px)' : 'calc(5rem + env(safe-area-inset-bottom, 0px) + 12px)';
...
function App() {
  ...
  const mainPaddingBottom = isStandalone ? 'calc(3.5rem + 8px)' : 'calc(3.5rem + env(safe-area-inset-bottom, 0px))';
